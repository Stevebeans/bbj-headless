...
export default function NewPostFAB() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 h-12 px-5 bg-secondary-500 hover:bg-secondary-400 text-primary-600 font-semibold text-sm whitespace-nowrap rounded-full shadow-lg transition-all"
      title="New Post"
    >
