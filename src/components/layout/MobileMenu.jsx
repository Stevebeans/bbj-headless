              ...
              {isAuthenticated ? (
                <>
                  <Link
                    href="/settings"
                    onClick={onClose}
                    className="w-full py-2.5 px-4 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg font-osw uppercase tracking-wide transition-colors flex items-center gap-2 justify-center"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
