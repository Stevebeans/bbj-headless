...
const weeks = [
  {
    id: 11, week_num: 1,
    players: [
      { player_id: 101, nom: 0, evicted: 0, voted_for: 0, saved_by_player_id: null, vote_to_win_for: null },
      { player_id: 103, nom: 1, evicted: 1, voted_for: 0, saved_by_player_id: null, vote_to_win_for: 101 },
      { player_id: 104, nom: 1, evicted: 0, voted_for: 103, saved_by_player_id: 102, vote_to_win_for: null },
    ],
    comps: [
...
describe("formToPayload", () => {
  ...
  it("omits jury_votes unless present, drops blank misc rows and zero votes", () => {
    const form = { hoh: 0, pov: 0, noms: [], vetoUsedOn: 0, evicted: [], votes: { 101: 0 }, miscComps: [{ player_id: 0, comp_type_id: 9, notes: "" }], summary: "", startDate: "", endDate: "", juryVotes: {} };
